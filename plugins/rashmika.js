...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'rashmika', fromMe: true, desc: 'صور rashmika عشوائية'}, (async (message, match) => {
...
var i = Math.floor(200*Math.random())
    ...
    Asena.addCommand({pattern: 'rashmika', fromMe: false, desc:'صور بنات عشوائية '}, (async (message, match) => {
...
r_text[200] = "https://i.ibb.co/qjySbDs/rashmika-mandanna-20200304-0051.jpg";
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'Made By YASER BOT'})
