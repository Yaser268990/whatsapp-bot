...
if (Config.LANG == 'EN') dd = 'يطبع داخل الملف على الخادم.', errmsg = '*الملف الذي تبحث عنه غير متوفر على الخادم!*'
...
if (Config.LANG == 'EN') bdesc = 'يرسل الصوت والفيديو والصور داخل الخادم.', berr = '*الملف الذي تبحث عنه غير متوفر على الخادم!*', need_way = '*مطلوب مسار الملف!*'
...
if (Config.LANG == 'EN') addsdesc = 'تحميل الصورة أو الصوت أو الفيديو إلى الخادم.', rep_add = '*الرد على أي رسالة إعلامية!*', suc_add = '*الوسائط المضافة إلى الخادم! ✅*'
...
if (Config.LANG == 'EN') ldc = '*تم اكتشاف الارتباط!*'
...
if (Config.LANG == 'EN') medinfo = 'يعرض المعلومات الفنية للفيديو الذي تم الرد عليه.'
...
if (Config.LANG == 'EN') sucmsg = '*تم إرسال الرسالة بنجاح ✅*', pmmm = 'لإرسال رسالة خاصة إلى الشخص الذي تم الرد عليه.', psmm = 'يرسل رسالة صوتية خاصة إلى المستفتى.'
